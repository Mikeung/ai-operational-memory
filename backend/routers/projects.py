...
from llm_intelligence.ingestion_limits import IngestionLimits, IngestionLimitsChecker
...
def get_project_storage(
    ...
    snapshot_stats = [
        r for r in store.get_project_snapshot_stats()
        if r.get("project_id") == project_id
    ]
    event_stats = [
        r for r in llm_store.count_events_by_project()
        if r.get("project_id") == project_id
    ]
