...
Routine and periodic maintenance procedures for AI Operational Memory.
...
```
/var/log/ai-operational-memory/*.log {
    daily
    rotate 7
    compress
    missingok
...
2. Check logs: `journalctl -u ai-operational-memory -n 50`
