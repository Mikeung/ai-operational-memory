...
class RecommendationEngine:
    ...
    def generate(
        ...
        recommendations.extend(self._recommend_from_topology(topology, scan_payload))
        recommendations.extend(self._recommend_from_workflows(workflows, topology))
        recommendations.extend(self._recommend_from_costs(cost_observations, topology))
        recommendations.extend(self._recommend_observability(topology, scan_payload))
