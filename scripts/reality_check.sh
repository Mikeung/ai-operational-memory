...
echo ""
echo "============================================"
echo "  AI Operational Memory — Reality Check"
echo "============================================"
echo ""
...
TEST_MSG="<b>AI Operational Memory — Reality Check</b>%0A%0AThis is a test message sent by the reality_check.sh script.%0A%0AIf you see this, Telegram delivery is working correctly.%0A%0A<i>$(date -u '+%Y-%m-%d %H:%M UTC')</i>"
...
echo "  [ ] Service is running: systemctl status ai-operational-memory (or equivalent)"
